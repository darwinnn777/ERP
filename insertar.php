...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($user) || empty($full_name) || empty($pass) || empty($rol_id)) {
        ...
        try {
            ...
            // Gestionar errores de base de datos (2300 el usuario ya existe)
            // Handle database errors (2300 - like duplicate username)
            if($e->getCode() == 23000){
        ...
        <div class="col-md-5">
            <div class="card card-login p-4">
                ...
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-bakery w-100 py-2">Dar de Alta</button>
                </form>
            </div>
